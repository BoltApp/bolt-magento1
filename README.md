...
| bolt_boltpay_validate_discounts_before | global | Entry for altering the behavior of discount validation prior to standard coupon and discount validation | **quote**<br>_Mage_Sales_Model_Quote_<br>the Magento cart copy of the Bolt order<br><br>**transaction**<br>_object_<br>Bolt payload | |
| bolt_boltpay_validate_discounts_after | global | Entry for adding additional discount validation behavior performed after standard coupon and discount validation | **quote**<br>_Mage_Sales_Model_Quote_<br>the Magento cart copy of the Bolt order<br><br>**transaction**<br>_object_<br>Bolt payload | |
