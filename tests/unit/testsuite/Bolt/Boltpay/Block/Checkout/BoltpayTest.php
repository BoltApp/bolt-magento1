...
class Bolt_Boltpay_Block_Checkout_BoltpayTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $expect = Mage::helper('boltpay/api')->getSecureUrl('checkout/cart');
    ...
    public function testGetSuccessURL()
    {
        ...
        $expect = Mage::helper('boltpay/api')->getSecureUrl($url);
    ...
    {
        $successUrl = Mage::helper('boltpay/api')->getSecureUrl('checkout/onepage/success');
    ...
    {
        $expect = Mage::helper('boltpay/api')->getSecureUrl('boltpay/order/save');
